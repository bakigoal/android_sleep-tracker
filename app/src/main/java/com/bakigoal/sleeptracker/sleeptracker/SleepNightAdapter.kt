...
import com.bakigoal.sleeptracker.convertDurationToFormatted
...
class SleepNightAdapter : RecyclerView.Adapter<SleepNightAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.qualityImage.setImageResource(getImageResource(item.sleepQuality))
    }

    private fun getImageResource(sleepQuality: Int) = when (sleepQuality) {
